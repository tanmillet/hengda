...
<div class="page02 main">
    ...
    <div id="navTabBox" class="ri mar"
         style="padding: 50px 100px 25px !important; width: 864px!important;line-height: 26px!important;">
        <div  style="display: block" id="page_cx">
            <?php echo htmlspecialchars_decode($news->news_desc)?>
        </div>
    </div>
</div>
<div class="footer">
