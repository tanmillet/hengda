layui.config({
    ...
    $('.delBanner').click(function () {
        ...
        layer.open({
            ...
            ,content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">确认进行删除幻灯片吗？</div>'
            ,yes: function(){
                layer.closeAll();
                ...
                $.ajax({
                    url: deurl + '/hdadmin/banner/del', type: 'post', data: {'bannerId':operId,'action':'del'}, dataType: 'json', success: function (rsp) {
                        layer.close(index);
