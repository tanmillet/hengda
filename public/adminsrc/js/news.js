layui.config({
    ...
    $('.delNews').click(function () {
        ...
        layer.open({
            ...
            ,content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">确认进行删除新闻吗？</div>'
            ,yes: function(){
                layer.closeAll();
                ...
                $.ajax({
                    url: deurl + '/hdadmin/news/del', type: 'post', data: {'newsId':operId,'action':'del'}, dataType: 'json', success: function (rsp) {
                        layer.close(index);
